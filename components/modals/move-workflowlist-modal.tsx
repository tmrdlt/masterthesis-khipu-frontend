    ...
    <div>
      ...
      <div className="absolute inset-0 flex justify-center">
        <button
          ...
          className="fixed z-50 mt-4 h-8 w-auto inline-flex items-center justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-sm text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:w-auto sm:text-sm"
        >
          Cancel moving
        </button>
      </div>
